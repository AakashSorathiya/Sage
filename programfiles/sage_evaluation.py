# This file contains the complete Sage implementation and evaluation on labeled dataset using domain-specific hypotheses and GPT model.
...
def sage():
    ...
    sage_results = infer_gpt(relevant_reviews)
    print(sage_results) # Report Sage results.
